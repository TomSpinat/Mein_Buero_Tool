...
SHIPMENT_DB_LABELS = {
    ...
    ShipmentStatus.ISSUE_DELAYED: "Problem/Verz\u00f6gert",
}
...
# Legacy-UI-Huelle (ehemals POMS): labels bleiben, intern wird in Domainen gemappt.
LEGACY_ORDER_OPTIONS = [
    ("Ordered (Waiting)", InventoryStatus.WAITING_FOR_ORDER),
    ("Sent (In Stock)", InventoryStatus.IN_STOCK),
    ("Delivered", InventoryStatus.DELIVERED),
    ("Canceled", InventoryStatus.CANCELLED),
]
