...
from module.einkauf_ui import EinkaufHeadFormWidget, EinkaufItemsTableWidget
...
class ScraperReviewWizardDialog(QDialog):
  ...
  def _build_ui(self):
    ...
    right_box.addWidget(self.einkauf_form_widget)
    ...
    right_box.addWidget(self.einkauf_items_widget, 1)
