...
class StyleManager:
    """
    Diese Klasse verwaltet das globale Styling (CSS/QSS) fÃ¼r das gesamte BÃ¼rokratie-Tool.
    ...
    def get_global_stylesheet():
        """
        Gibt den kompletten CSS-String fÃ¼r alle Widgets zurÃ¼ck im modernen 'Dark/Neon'-Look.
        """
        return """
        /* =========================================
        ...
        QLabel#TitleLabel, QLabel.title {
            font-size: 22px;
            font-weight: bold;
            color: #00E4FF; /* Cyan Accent fÃ¼r Ãœberschriften */
        }
        ...
        QPushButton:pressed, QPushButton.retro-btn:pressed {
            ...
            padding-top: 12px;
            padding-bottom: 8px; /* leichter DrÃ¼ck-Effekt */
        }
