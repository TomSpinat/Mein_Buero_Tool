"""
modul_todo.py
Erstellt das Sidebar-Widget fÃ¼r die To-Do-Liste, das permanent im Dashboard angezeigt wird.
"""
...
class ToDoWidget(QWidget):
    ...
    def __init__(self, settings_manager):
        ...
        # Flexible Breite fÃ¼r Skalierung, statt fester 300px
    ...
    def refresh_todos(self):
        ...
        if not items:
            lbl_empty = QLabel("Nichts zu tun! Geh einen Kaffee trinken. â˜•")
